...
def default_config() -> ScenarioConfig:
    return ScenarioConfig(
        ...
        group_p_baseline={
            GroupType.HOUSEHOLD: 0.99,
            GroupType.KIN: 0.50,
            GroupType.SCHOOL: 0.40,
            GroupType.WORKPLACE: 0.30,
            GroupType.RECURRING_LEISURE: 0.40,
            GroupType.ONE_OFF_EVENT: 0.50,
            GroupType.COMMUNITY: 0.040,
        },
        group_m_bar={
