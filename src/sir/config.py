...
def default_config() -> ScenarioConfig:
    return ScenarioConfig(
        ...
        group_p_baseline={
            GroupType.HOUSEHOLD: 0.25,
            GroupType.KIN: 0.10,
            GroupType.SCHOOL: 0.05,
            GroupType.WORKPLACE: 0.04,
            GroupType.RECURRING_LEISURE: 0.05,
            GroupType.ONE_OFF_EVENT: 0.10,
            GroupType.COMMUNITY: 0.005,
        },
        group_m_bar={
